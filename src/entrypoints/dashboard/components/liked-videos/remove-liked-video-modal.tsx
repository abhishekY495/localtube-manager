import { deleteLikedVideoById } from "@/entrypoints/indexed-db/liked-videos";
import toast from "react-hot-toast";

export const RemoveLikedVideoModal = ({
      ...
      <div className="w-[360px] mt-[-420px] border-2 border-neutral-800 bg-neutral-900 rounded">
        <div className="flex flex-col gap-2 p-4">
          ...
          <p className="text-sm text-neutral-400">
            This action cannot be undone. This will permanently remove the liked
            video.
          </p>
        </div>
