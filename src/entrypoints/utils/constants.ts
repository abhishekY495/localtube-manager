...
export const SELECTORS = {
  ...
  SUBSCRIBE_BTN_FROM_VIDEO_PAGE_ELEMENTS: [
    "#above-the-fold",
    "#top-row",
    "#owner",
  ],
...
export const CUSTOM_SUBSCRIBE_BUTTON_ID = "custom-ltm-subscribe-btn";
export const CUSTOM_SUBSCRIBED_BUTTON_ID = "custom-ltm-subscribed-btn";
